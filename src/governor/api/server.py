"""FastAPI cockpit API — a THIN layer over governor.service (no logic moved,
...
Run:  uv run uvicorn governor.api.server:app --port 8800
"""
...
from governor.api.governor import governor
...
async def ask(q: str | None = None, agent: str | None = None, session: str | None = None):
    ...
    from governor.api import ask as ask_mod
...
from governor.api.governor import _FLEET, _FLEET_ORDER  # noqa: E402
