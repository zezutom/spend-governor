...
the cache where align/fixture read them:
    ...
    ACCOUNTANT_INGEST_URL=http://localhost:8765 \\
        uv run python -m accountant.trace_race.capture "I want a refund for order 12345"
...
def capture_pair(ticket: str, customer_id: str = "race-demo") -> dict:
    ...
    from accountant.wrapper import wrapper as gov
...
def main() -> None:
    ...
    from accountant.trace_race.fixture import build_and_save
